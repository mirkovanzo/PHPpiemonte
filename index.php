...
?>		
			<aside class="col-md-5 visible-xs visible-lg">
			<h3></h3>
			...
			<div id="main" class="col-md-offset-4">
				...
				<div class="row">
					<div class="container">
						<div class="col-sm-7 visible-md visible-lg">
							<figure>
				...
				<ul>
					...
					<li>
						<p>
							...
							<a href="lago-maggiore.php">Lago<br/>Maggiore</a>
